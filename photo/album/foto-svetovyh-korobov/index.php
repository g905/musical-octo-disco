...
$APPLICATION->SetPageProperty("title", "Фотографии световых коробов на такси - ПК «НОСТ» | Страница ".$page);
$APPLICATION->SetPageProperty("description", "Весь ассортимент производимых ПК «НОСТ» световых рекламных коробов на такси, представленный в виде фотографий для того, чтобы Вы могли по достоинству оценить качество нашей продукции | Страница ".$page);
