...
$APPLICATION->SetPageProperty("title", "Страница ".$page." | Фотографии магнитных наклеек на такси - ПК «НОСТ»");
$APPLICATION->SetPageProperty("description", "Страница ".$page." | Весь ассортимент производимых ПК «НОСТ» магнитных наклеек на такси, представленный в виде фотографий для того, чтобы Вы могли по достоинству оценить качество выпускаемой нами продукции");
