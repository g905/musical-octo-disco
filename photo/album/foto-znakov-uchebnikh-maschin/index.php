...
$APPLICATION->SetPageProperty("title", "Фотографии световых учебных коробов - ПК «НОСТ» | Страница ".$page);
$APPLICATION->SetPageProperty("description", "Весь ассортимент производимых ПК «НОСТ» световых учебных коробов, представленный в виде фотографий для того, чтобы Вы могли по достоинству оценить качество производимой нами продукции | Страница ".$page);
