...
$curElementID = CIBlockFindTools::GetElementID(
...
// adl 24.06.14 Добавляем название статьи в хлебные крошки
if(CModule::IncludeModule("iblock")) {

	$res = CIBlockElement::GetByID(/*$arResult["VARIABLES"]["ELEMENT_ID"]*/$curElementID);
...
// adl 24.06.14 Добавляем название товара в хлебные крошки
if(CModule::IncludeModule("iblock")) {
