function Beono_Banner_Rotation (settings) {
	...
	this.showBanner = function (next_banner_index) {
		...
		if (this.hasPager) {
			...
			$('div.beono-banner_slider-pager div', __context).removeClass('activ'); // adl 12.08.13 Прикручиваем шаблон
			$('div.beono-banner_slider-pager a:eq('+next_banner_index+')', __context).addClass('active');
			$('div.beono-banner_slider-pager div:eq('+(next_banner_index+1)+')', __context).addClass('activ'); // adl 12.08.13 Прикручиваем шаблон
