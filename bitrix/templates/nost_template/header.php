...
<?$APPLICATION->IncludeComponent("beono:banner_rotation", "nost_temple", array(
	"SOURCE" => "medialib",
	"LIMIT" => "3",
	"BANNER_IMAGE_1" => "/upload/banner-main/banner-first.jpg",
	"BANNER_NAME_1" => "",
	"BANNER_HREF_1" => "",
	"BANNER_IMAGE_2" => "/upload/banner-main/banner-second.jpg",
	"BANNER_NAME_2" => "",
	"BANNER_HREF_2" => "",
	"BANNER_IMAGE_3" => "/upload/banner-main/banner-third.jpg",
	"BANNER_NAME_3" => "",
	"BANNER_HREF_3" => "",
	"JQUERY" => "Y",
	"PAGER_STYLE" => "digits",
