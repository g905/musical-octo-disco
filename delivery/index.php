			...
			<div class="row center-row">
				...
				<div class="col-xs-24 col-xs-push-1 center">
					...
					<p>
						...
						При оформлении заказа Вы сможете выбрать удобную для Вас транспортную компанию и согласовать все условия доставки.<br>
						<font color="red">Внимание!</font> Доставка груза оплачивается отдельно, при получении в транспортной компании
					</p>
				</div>
			</div>
			<div class="row center-row">
